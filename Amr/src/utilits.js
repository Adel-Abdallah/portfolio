...
var workexperincewidth =
  aboutwidth + $(".workExperience").width() - 10;
var portfoliowidth =
  workexperincewidth +
...
var contactwidth =
  portfoliowidth + $(".contact").width() + $(".testimonials").width() - 10;
    ...
    function checkScroll() {
      var scrollPosition = Math.abs(parseInt($(".mCSB_container").css("left")));
    
      if (scrollPosition >= homewidth && scrollPosition < aboutwidth) {
        $(".menu ul li span").removeClass("active");
        $("#about-link").addClass("active");
      } else if (scrollPosition >= aboutwidth && scrollPosition < workexperincewidth) {
        $(".menu ul li span").removeClass("active");
        $("#work-experience-link").addClass("active");
      } else if (scrollPosition >= workexperincewidth && scrollPosition < portfoliowidth) {
        $(".menu ul li span").removeClass("active");
        $("#portfolio-link").addClass("active");
      } else if (scrollPosition >= portfoliowidth && scrollPosition < contactwidth) {
        $(".menu ul li span").removeClass("active");
  ...
  $(document).ready(function () {
    ...
    $("#work-experience-link").on("click", function () {
      $("#wrapper").mCustomScrollbar("scrollTo", "#workexperience", {
        scrollInertia: 1500,
      });
    });
